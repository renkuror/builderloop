...
| Module receipt lifecycle and local replay retention | `src/protocol.js::CampaignLedger` | D01-D14 | `pnpm test` | PASS (local model); Ed25519 instruction validation absent | `758c8f1` |
